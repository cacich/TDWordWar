 ...
 *
 * 平衡基準（一般兵）：`thief` = hpMul 1 / def 0 / speed 0.95 / bounty 2。
...
export const ENEMIES: EnemyDef[] = [
  // ── 一般兵 ────────────────────────────────────────────
  { key: 'thief', char: '賊', hpMul: 1, def: 0, speed: 0.95, flying: false, bounty: 2, damage: 1, troop: '步', traits: [], desc: '尋常賊寇（步）。' },
  { key: 'shield', char: '盾', hpMul: 1.9, def: 45, speed: 0.7, flying: false, bounty: 4, damage: 1, troop: '步', traits: ['armored'], desc: '盾賊（步）：防禦極高，怕穿透與灼燒。' },
  { key: 'swift', char: '快', hpMul: 0.55, def: 0, speed: 2.1, flying: false, bounty: 2, damage: 1, troop: '騎', traits: ['fast'], desc: '快賊（騎）：移速極快，血薄，怕步兵。' },
  { key: 'flyer', char: '飛', hpMul: 0.9, def: 10, speed: 1.35, flying: true, bounty: 4, damage: 1, troop: '弓', traits: ['flying'], desc: '飛賊（弓）：只有射程 ≥2 的單位打得到，怕騎兵。' },

  // 新敵種：每一種都對應一個玩家既有工具，讓後期的敵人組成不再只是血量變多
  {
    key: 'shaman', char: '妖', hpMul: 0.8, def: 5, speed: 0.8, flying: false, bounty: 5, damage: 1, troop: '步',
    traits: ['healer'], minWave: 6, healAura: { radius: 2.4, hps: 0.05 },
    desc: '妖道（步）：不攻擊，但每秒為周圍敵人回血。優先集火解決。',
  },
  {
    key: 'armor', char: '甲', hpMul: 2.4, def: 75, speed: 0.6, flying: false, bounty: 6, damage: 1, troop: '步',
    traits: ['armored'], minWave: 8,
    desc: '甲賊（步）：防禦誇張，普通攻擊幾乎打不動。灼燒無視防禦，是最好的解法。',
  },
  {
    key: 'splitter', char: '裂', hpMul: 1.5, def: 10, speed: 0.85, flying: false, bounty: 4, damage: 1, troop: '步',
    traits: ['splitter'], minWave: 9, splitInto: { key: 'swarmlet', count: 2 },
    desc: '分裂賊（步）：死亡時分裂成兩隻蟻賊。純單體輸出會被拖住。',
  },
  {
    key: 'gale', char: '疾', hpMul: 0.7, def: 0, speed: 2.4, flying: false, bounty: 4, damage: 1, troop: '騎',
  ...
  {
    key: 'stone', char: '磐', hpMul: 4.5, def: 30, speed: 0.4, flying: false, bounty: 8, damage: 1, troop: '步',
