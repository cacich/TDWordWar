...
目前各關的傻 AI 中位數（目標 12～20）：黃巾 12（滿關）／董卓 18（滿關）／巨鹿 20／官渡 20／
赤壁 17／五丈原 18／襄陽 19／漢中 19／洛陽 18。
...
編隊（從已解鎖的字／武將手動挑選字池內容，見 `data/loadout.ts`）、心願單。音效與粒子皆由 sim 事件佇列驅動。
